...
async def _(bot: Bot, event: Event):
    uid = [672346917, 672353429, 351609538, 672328094, 672342685, 703007996, 386900246, 27735697, 518817, 380829248]
    name = ["向晚", "贝拉", "珈乐", "嘉然", "乃琳", "Asoul_official", "神楽七奈Official", "木子喵neko", "早凉", "花园Serena"]
